...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<div class="row">
			<div class="col-md-2">
				<img id="imgPhoto" src="<?=$foto_kader?>" alt="" style="width: 100%; height: auto; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px;">
			...
			<div class="col-md-10">
				...
				<ul class="nav nav-tabs" role="tablist">
					...
					<li role="presentation"><a href="#riwayat_organisasi" aria-controls="profile" role="tab" data-toggle="tab">Riwayat Organisasi dan Kepanitiaan</a></li>
					<li role="presentation"><a href="#riwayat_kepanitiaan" aria-controls="messages" role="tab" data-toggle="tab">Riwayat Prestasi</a></li>
			  ...
			  <div class="modal-body">
				...
				<div id="form_kepanitiaan">
					<div class="form-group">
						...
						<input id="txt_tahun_kepanitiaan" type="text" class="form-control" placeholder="Masukkan tahun prestasi...">
					</div>
					<div class="form-group">
						<label for="">Perlombaan:</label>
						<input id="txt_kegiatan_kepanitiaan" type="text" class="form-control" placeholder="Masukkan prestasi yang didapat...">
					</div>
					<div class="form-group">
						<label for="">Peringkat:</label>
						<input id="txt_jabatan_kepanitiaan" type="text" class="form-control" placeholder="Masukkan peringkat/keterangan prestasi...">
					</div>
				</div>
			  </div>
			  <div class="modal-footer">
			...
			<div class="modal-content">
			  ...
			  <div class="modal-body">
				...
				<div id="form_organisasi">
					...
					<div class="form-group">
						<label for="">Organisasi/Kepanitiaan:</label>
		...
		<script>
			...
			setupPhoto('<?=base_url('/upload/do_upload')?>');

			setImgIdPhoto(<?=$id_kader?>);
