...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Event Gamais ITB
						<?php if($current_page == 'listAcara') { ?> 
							<a href="<?=$base_path;?>addAcara" class="btn btn-primary btn-sm" style="margin-top: -5px;">
								<span class="glyphicon glyphicon-plus"></span> Tambah Event
							</a>
						...
						<?php } else { ?>
							<a href="<?=$base_path;?>listAcara" class="btn btn-primary btn-sm" style="margin-top: -5px;">
								<span class="glyphicon glyphicon-arrow-left"></span> Kembali ke list Event
						...
						<div class="pull-right" style="padding-right: 0.3em;">
							<a href="<?=$base_path;?>seeAllKaderGamais" class="btn btn-primary btn-sm" style="margin-top: -35px; background-color: #40D49D; border-color: #40D49D;">
								<span class="glyphicon glyphicon-user"></span> Lihat Kader 
							</a>
						</div>
					</h1>
